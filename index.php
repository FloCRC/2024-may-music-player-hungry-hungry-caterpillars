        ...
        <section class="group-[.minimised]:h-[calc(100%-6rem)] h-3/4 p-12 overflow-auto">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 mt-12 gap-5">
                ...
                <div class="">
                    ...
                    <div class="rounded bg-cyan-950 px-3 py-2 hover:bg-cyan-800 hover:cursor-pointer flex justify-between items-center mb-3">
                        <div>
                ...
                <div class="">
                    ...
                    <div class="border-b border-slate-500 pb-5 mb-3 flex justify-between items-center">
