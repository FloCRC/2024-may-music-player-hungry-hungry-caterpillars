...
{
    public static function displayRecentSong(int $songId, string $songTitle, string $artistName, string $songLength): string
    {
                    ...
                    return "<div class='rounded bg-cyan-950 px-3 py-2 hover:bg-cyan-800 hover:cursor-pointer flex justify-between items-center mb-3'>
                        ...
                        <div class='flex items-center justify-between w-24'>
                            ...
                            <a href='?playSong=1&songID=' class='hover:text-slate-500 hover:cursor-pointer'>
