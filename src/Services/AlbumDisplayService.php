...
{
    public static function displayPopularAlbum(string $albumArtwork, string $albumTitle, string $albumArtist, int $albumArtistId): string
    {
       return "<div class='border-b border-slate-500 pb-5 mb-3 flex justify-between items-center'>
                            <img class='w-[50px]' src=$albumArtwork />
                            <div class='w-3/4 px-3'>
                                <h4 class='font-bold text-lg'>$albumTitle</h4>
